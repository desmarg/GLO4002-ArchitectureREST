...
public class TransactionBuyTest {
    ...
    private final Credits SOME_STOCK_PRICE = new Credits(new BigDecimal(123), Currency.CAD);
    private final AccountNumber VALID_ACCOUNT_NUMBER = new AccountNumber("TD-0000");
    private final Credits PRICE_WITH_FEE = new Credits(new BigDecimal(123.25), Currency.CAD);
