...
//
//    @Test
//    public void givenTotalLessThan5000AndQuantitySmallerThan100_whenCalculatingFees_thenQuarterRateFees() {
...
//
//    @Test
//    public void givenTotalLessThan5000AndQuantityBiggerThan100_whenCalculatingFees_thenFifthRateFees() {
...
//        Credits transactionFees = this.transaction.getFees();
//
//        Credits additionalFees = this.transaction.getValue().multiply(Transaction.FEE_OVER_5000);
//        Credits expectedFees =
//                Transaction.FEE_UNDER_100.multiply(Credits.fromLong(this.VALID_QUANTITY_BIGGER_THAN_HUNDRED)).add(additionalFees);
