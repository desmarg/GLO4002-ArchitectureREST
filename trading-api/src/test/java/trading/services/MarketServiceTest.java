...
public class MarketServiceTest {
    ...
    private final DateTime OPENING_DATETIME = new DateTime(Instant.parse("2018-08-04T06:00:00Z"));
    private final DateTime CLOSING_DATETIME = new DateTime(Instant.parse("2018-08-04T17:00:00Z"));
    ...
    @Test
    public void givenOpenedDateTimeAndEmptyTimeZone_whenCheckingIfMarketOpenedAtTheOpeningTime_thenReturnTrue() {
        ArrayList<String> hours = new ArrayList<>();
        hours.add(this.MORNING_HOURS);
        hours.add(this.PM_HOURS);
        MarketDTO marketDTO = new MarketDTO();
        ...
        marketDTO.timezone = this.ZERO_TIMEZONE;
        when(this.jerseyClient.getRequest(any(), any())).thenReturn(marketDTO);
        assertTrue(this.marketService.isMarketOpenAtHour(this.MARKET_SYMBOL, OPENING_DATETIME));
    }
    ...
    public void givenOpenedDateTimeAndEmptyTimeZone_whenCheckingIfMarketClosedAtTheClosingTime_thenReturnFalse() {
        ...
        marketDTO.timezone = this.ZERO_TIMEZONE;
        when(this.jerseyClient.getRequest(any(), any())).thenReturn(marketDTO);
        assertFalse(this.marketService.isMarketOpenAtHour(this.MARKET_SYMBOL, CLOSING_DATETIME));
    }
